      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-[color:var(--text)] text-lg font-bold mb-4">CTF Platform</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/rules" className="hover:text-[color:var(--primary)] transition-colors">
                  Rules
                </Link>
              </li>
              <li>
                <Link href="/faq" className="hover:text-[color:var(--primary)] transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-[color:var(--text)] font-semibold mb-4">Resources</h4>
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="/docs"
